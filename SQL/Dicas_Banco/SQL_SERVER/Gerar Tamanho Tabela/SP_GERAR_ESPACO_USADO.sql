...
************************************/
CREATE TABLE SS_TAMANHO_TABELA(
	DT_LOG SMALLDATETIME
	,DS_TABELA VARCHAR(254)
	,NR_LINHAS BIGINT
	,NR_RESERVADO_KB BIGINT
	,NR_TAMANHO_KB BIGINT
	,NR_TAMANHO_INDICE_KB BIGINT
	,NR_ESPACO_NAO_USADO_KB BIGINT
)
GO

/***********************************
* Chamada da SP para todas tabelas
************************************/	
CREATE PROCEDURE [SP_DB_ANALISAR_TABELAS_TAMANHO]
(@FILTRO_TABELA VARCHAR(255) = null) as 
	...
	BEGIN
		...
		EXEC SP_GRAVAR_TAMANHO_TABELAS @TABELA
...
/***********************************
* Procedure para alimentar tabela
************************************/	
CREATE PROCEDURE [SP_GRAVAR_TAMANHO_TABELAS] --- 2003/05/19 14:00

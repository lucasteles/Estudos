...
public class Lista {
    ...
    {
        this.nVetor = new Object[ nTaman ];
    }

    public Object Get(int nValue)
    {
    ...
    public void Add(Object nValue)// podia ser void mesmo.
    {
        if(nIndice >= this.nVetor.length){
    	   Object[] aux = new Object[nIndice+1];
    ...
    public boolean Contains(Object nValue)
    {

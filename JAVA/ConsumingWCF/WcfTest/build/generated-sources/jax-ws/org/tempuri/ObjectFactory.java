...
public class ObjectFactory {
    ...
    private final static QName _PutDataValue_QNAME = new QName("http://tempuri.org/", "value");
    ...
    /**
     * Create an instance of {@link PutDataResponse }
     * 
     */
    public PutDataResponse createPutDataResponse() {
    ...
    /**
     * Create an instance of {@link PutData }
     * 
     */
    public PutData createPutData() {
        return new PutData();
    }
    ...
    public JAXBElement<ArrayOfstring> createGetDataResponseGetDataResult(ArrayOfstring value) {
        return new JAXBElement<ArrayOfstring>(_GetDataResponseGetDataResult_QNAME, ArrayOfstring.class, GetDataResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "value", scope = PutData.class)
    public JAXBElement<String> createPutDataValue(String value) {
        return new JAXBElement<String>(_PutDataValue_QNAME, String.class, PutData.class, value);
    }

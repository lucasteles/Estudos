 ...
 * 
 */
@WebServiceClient(name = "Service1", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://mywcftest.azurewebsites.net/Service1.svc?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://mywcftest.azurewebsites.net/Service1.svc?wsdl");

 ...
 * http://fightcodega.me/
 */
var FightCodeEngine, __slice = [].slice, __hasProp = {}.hasOwnProperty, __extends = function (e, t)
{
    function r()
    {
        this.constructor = e
...
FightCodeEngine = {}, FightCodeEngine.create_fight = function ()
{
    ...
    }(), l = function ()
    {
        function t(n)
        {
            ...
            {
                if (e === 0)return;
                return this.queue.push({action: "move", direction: t, count: Math.abs(e) / o}), !0
            ...
            {
                if (t === 0)return;
                return this.queue.push({action: "rotateCannon", direction: t, count: Math.abs(t) / e})
            ...
            {
                if (t === 0)return;
                return this.queue.push({action: "turn", direction: t, count: Math.abs(t) / e})
            ...
            {
                return this.queue.push({action: "fire"})
            }, this.notify = function (e)
            {
                return this.queue.push({action: "notify", callback: e})
            ...
            {
                return this.queue.push({action: "clone"})
            }, this.disappear = function ()
            {
                return this.queue.push({action: "disappear"})
            }, this.log = function ()
            {
                var e;
                return e = 1 <= arguments.length ? __slice.call(arguments, 0) : [], this.queue.push({action: "log", messages: e})
            }, this.ignore = function (e)
            {
                return this.queue.push({action: "ignore", eventName: e})
            }, this.listen = function (e)
            {
                return this.queue.push({action: "listen", eventName: e})
            },

            this.data = function(data)
            {
                this.queue.push({action: 'data', data : data});
            }
        }
    ...
    }(), f = function ()
    {
        ...
        {
            return this.dimension = {width: e, height: t}, this.halfWidth = e / 2, this.halfHeight = t / 2, this.radius = Math.sqrt(this.halfWidth * this.halfWidth + this.halfHeight * this.halfHeight), this.minRadius = Math.min(this.halfWidth, this.halfHeight), this.updateCoords()
    ...
    }(r), c = function (t)
    {
        ...
        {
            this.isInvisible = !0, this.pushEventToLog({type: "beginInvisibility", id: this.id})
        }, r.prototype.decInvisibleRounds = function ()
        {
            this._invisibleRounds--, this._invisibleRounds < 0 && (this.isInvisible = !1, this.pushEventToLog({type: "endInvisibility", id: this.id}))
        }, r.prototype.stats = function ()
        {
            return{bulletsFired: this.clones.reduce(function (e, t)
            {
                return e + t.bulletsFired
            }, this.bulletsFired), bulletsHit: this.clones.reduce(function (e, t)
            {
                return e + t.bulletsHit
            }, this.bulletsHit), bulletsTaken: this.clones.reduce(function (e, t)
            {
                return e + t.bulletsTaken
            }, this.bulletsTaken), enemiesKilled: this.clones.reduce(function (e, t)
            {
                return e + t.enemiesKilled
            }, this.enemiesKilled), friendsKilled: this.clones.reduce(function (e, t)
            {
            ...
            while (i)
            {
                switch (i.action)
                {
                    ...
                    case"listen":
                        ...
                        break;
                    case"log":
                        this.pushEventToLog({type: "log", messages: i.messages.join("\n"), id: this.id});
                        break;

                    case 'data':
                        this.pushObjectToLog({type : 'data', data : i.data});
                        break;
    ...
    }(r), i = function ()
    {
        ...
        }, e.prototype.checkCollision = function (e)
        {
            ...
            r = e instanceof c ? new l(e) : null, p = e.rectangle.containingCollisionAngle(this.arena.rectangle), p && (e.rollbackAfterCollision(), e instanceof n ? (e.destroy(), this.pushEventToLog({type: "exploded", id: e.id})) : (i = d(p - e.rectangle.angle - 90), i > 180 && (i -= 360), e.abortCurrentMovement(), e.ignoredEvents.onWallCollision || (r.ignore("onWallCollision"), this.safeCall(e.robot.instance, "onWallCollision", {robot: r, bearing: i}), r.listen("onWallCollision"))));
            ...
            for (v = 0, g = b.length; v < g; v++)
            {
                ...
                if (e.rectangle.intersects(a.rectangle))
                {
                    ...
                    if (a instanceof n)
                    {
                        ...
                        o = "onHitByBullet", e.takeHit(a), this.pushEventToLog({type: "exploded", id: a.id});
                        if (!e.isAlive())
                        {
                            this.pushEventToLog({type: "dead", id: e.id}), w = e.clones;
                            for (m = 0, y = w.length; m < y; m++)s = w[m], this.pushEventToLog({type: "dead", id: s.id})
                        }
                    ...
                    i > 180 && (i -= 360), e.ignoredEvents[o] || (r.ignore(o), this.safeCall(e.robot.instance, o, {robot: r, bearing: i, collidedRobot: u ? this.basicEnemyInfo(a) : null, myFault: !!u}), r.listen(o)), u && a.addAccidentalCollision(e)
                } else u && t[a.id] && (e.ignoredEvents[o] || (f = h.subtract(a.rectangle.position, e.rectangle.position), i = d(Math.atan2(f.y, f.x) * 180 / Math.PI - e.rectangle.angle), i > 180 && (i -= 360), r.ignore(o), this.safeCall(e.robot.instance, o, {robot: r, bearing: i, collidedRobot: this.basicEnemyInfo(a), myFault: !1}), r.listen(o)))
            }
            return r
        }, e.prototype.checkSight = function (e)
        {
            ...
            return s && !s.isInvisible && (e.preventScan(), t.ignore("onScannedRobot"), this.safeCall(e.robot.instance, "onScannedRobot", {robot: t, scannedRobot: this.basicEnemyInfo(s)}), t.listen("onScannedRobot"), this.pushEventToLog({type: "onScannedRobot", id: e.id})), t
        }, e.prototype.basicEnemyInfo = function (e)
        {
            return{id: e.id, position: new h(e.rectangle.position), angle: e.rectangle.angle, cannonAngle: e.cannonAngle, life: e.life, parentId: e.parentStatus ? e.parentStatus.id : null}
        ...
        }, e.prototype.fight = function ()
        {
            ...
            return{isDraw: this.isDraw(), robots: o, result: n}
        }, e
    }(), function ()
    {
        ...
        return f = arguments[0], t = arguments[1], r = arguments[2], s = arguments[3], n = arguments[4], a = arguments[5], u = 7 <= arguments.length ? __slice.call(arguments, 6) : [], e = function (e, t, n)
        {
            ...
            var r = new n, i = e.apply(r, t), s = typeof i;
            return s == "object" || s == "function" ? i || r : r
        }(i, [f, t, r, s, n].concat(__slice.call(u)), function ()
        {
        }), a && (e.roundLogCallback = a), o = e.fight(), o
    }
}();
var Fight, global, runFight, worker, __bind = function (e, t)
{
    return function ()
    {
...
worker = self, global = this, Fight = function ()
{
    function e()
    {
        this.onRoundLog = __bind(this.onRoundLog, this), global.console = {log: this.log}, this.bindEvents()
    }

    return e.prototype.overrideFunctions = function ()
    {
        return this.originalFunctions = {setTimeout: global.setTimeout, setInterval: global.setInterval, XmlHttpRequest: global.XmlHttpRequest, Date: global.Date, random: Math.random, eval: global.eval, func: global.Function}, global.setTimeout = function ()
        {
    ...
    }, e.prototype.restoreFunctions = function ()
    {
        return global.setTimeout = this.originalFunctions.setTimeout, global.setInterval = this.originalFunctions.setInterval, global.XmlHttpRequest = this.originalFunctions.XmlHttpRequest, global.Date = function ()
        {
            return this.originalFunctions.Date
        }, Math.random = function ()
        {
            return this.originalFunctions.random
        }, global.eval = this.originalFunctions.eval, global.Function = this.originalFunctions.func
    }, e.prototype.log = function ()
    {
        var e;
        return e = 1 <= arguments.length ? __slice.call(arguments, 0) : [], worker.postMessage({type: "log", message: e.join(", ")})
    }, e.prototype.bindEvents = function ()
    {
        var e = this;
        return worker.onmessage = function (t)
        {
            var n, r, i, s, o, u, a, f;
            i = t.data, u = [];
            for (s = a = 1, f = i.robots; 1 <= f ? a <= f : a >= f; s = 1 <= f ? ++a : --a)r = i["robot" + s], r.code = r.code.replace(/\/\/.*?\n/g, "").replace(/#.*?\n/g, ""), u.push(r);
            return n = i.boardSize || {width: 800, height: 500}, o = i.maxRounds || 1e4, e.streaming = i.streaming, e.processFight(u, o, n)
        }
    }, e.prototype.onRoundLog = function (e)
    {
        return worker.postMessage({type: "stream", roundLog: e})
    }, e.prototype.processFight = function (e, t, n)
    {
        var r, i, s, o, u, a, f;
        this.overrideFunctions();
        for (a = 0, f = e.length; a < f; a++)
        {
            o = e[a], u = "(function() {" + o.code + "; global.Robot = Robot;}.bind(global)()); return global.Robot;";
            try
            {
                o.constructor = (new this.originalFunctions.func("global", u))({})
            } catch (l)
            {
                return worker.postMessage({type: "error", result: null, error: l.toString()}), null
            }
        }
        return r = null, this.streaming && (r = this.onRoundLog), s = FightCodeEngine.create_fight.apply(FightCodeEngine, [n.width, n.height, t, this.originalFunctions.random, !0, r].concat(__slice.call(e))), this.restoreFunctions(), i = {type: "results", result: s.result}, worker.postMessage(i), null
    }, e
}(), runFight = function ()
{
    var e;

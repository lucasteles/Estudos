...
namespace Queries.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<PlutoContext>
    {
        ...
        protected override void Seed(PlutoContext context)
        {
            ...
            var tagsDb = context.Set<Tag>();
            foreach (var tag in tags.Values)
            tagsDb.AddOrUpdate(t => t.Id, tag);
            #endregion
            ...
            var authorsDb = context.Set<Author>();
            foreach (var author in authors)
                authorsDb.AddOrUpdate(a => a.Id, author);
            #endregion
            ...
            var CourseDb = context.Set<Course>();
            foreach (var course in courses)
                CourseDb.AddOrUpdate(c => c.Id, course);
            #endregion
        }
    }
}
